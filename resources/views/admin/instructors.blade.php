    ...
    <section class="admin-dashboard-section">
        <div class="admin-dashboard-right-side">
            ...
            <div class="dashboard-course-area">
                ...
                <div class="wrap-details">
                    <h5><a href="">{{ $instructor->name }} @if ($instructor->status == 'suspended')<sup style="color: red"><span style="text-transform:uppercase; font-size:12px">{{ $instructor->status}}</span></sup> @else<sup style="color:lawngreen"><span style="text-transform:uppercase; font-size:12px">{{ $instructor->status}}</span></sup> @endif
                        </a></h5>
                    <divclass="user-area">
                        ...
                        <div style="display:flex; justify-content:space-between; margin-right:20rem">
                            <p>Web Developer</p>
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <div>
                                        <form method="post">
                                            ...
                                            <div>
                                                ...
                                                <a style="width: 100px" href="/suspend/{{$instructor->id}}"><button class="btn btn-danger" type="submit">Suspend</button></a>
                                            </div>
                                        </form>
                                    </div>
                                    @else
                                    <form method="post">
                                        ...
                                        <div>
                                            <input type="hidden" name="id" value="{{ $instructor->id }}">
                                            <a style="  width: 100px" href="/suspend/{{$instructor->id}}"><button class="btn btn-primary" type="submit">Unsuspend</button></a>
                                        </div>
                                    </form>
                                </div>
                                @endif
        ...
        <div class="dashboard-left-menu">
            ...
            <ul>
                ...
                @if(Auth::user()->hasRole('instructor'))
                <li class="nav-item">
                    <a class="dashboard-item-menu" href="dashboard-course.html"><i class="fas fa-graduation-cap"></i>Courses</a>
                </li>
                @endif
