            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <!-- <h5>INTRUCTIONS</h5>
                            <p>Kindly add each module at a time </p>
                            <p>i.e add a module 1 and submit , then add module2 and submit etc </p>

                            <p style="color: red;">Submit course description and price once</p> -->
                            <hr>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="moduletitle" id="email" placeholder="Enter Module Title">
