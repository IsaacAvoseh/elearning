...
<body class='sc5'>
    ...
    <section class="admin-dashboard-section">
        <div class="admin-dashboard-right-side">
                        ...
                        <div class="card-body">
                            ...
                            <form action="/categories" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">Category Name</label>
                                            <input type="text" class="form-control" name="name" id="email" placeholder="Add new Category">
                                    ...
                                    <div class="col-md-6" style="margin-top: 25px;">
                                        <div class="form-group">Trending</label>
                                            <select class="form_control" name="trending" id="">
            ...
            <div class="dashboard-course">
                <h5 class="dashboard-title">Categories</h5>
                @include('flash')
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td scope="row">{{ $cat->name }}
                                </td>
                                <td>{{ $cat->trending}}</td>

                                <td><a style="background-color: blue;" class="btn btn-primary" href="#">Edit</a> || <a style="background-color: crimson;" class="btn btn-primary" href="/category/{{ $cat->id}}">Delete</a> </td>
